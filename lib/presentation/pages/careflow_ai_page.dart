        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                      fontSize: 10,
                      color: (isUser ? colorScheme.onPrimary : colorScheme.onSurfaceVariant).withOpacity(0.7),
                    ),
                  ),
                ],
              ),
          ...
          if (isUser)
            CircleAvatar(
              ...
              child: Icon(Icons.person_outline, size: 20, color: colorScheme.secondary),
            ),
        ],
      ),
    );
